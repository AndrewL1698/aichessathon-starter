...
|---|---|---|---|
| `eval/mobility` | PR #19, **rejected** | Knight, bishop, rook and queen mobility in both evaluations: squares attacked, less our own men and the squares enemy pawns cover, scored against a typical count per piece. | Two controls, opposite signs, negative where it matters: 53.1% over 64 games at 10 s + 0.1 s (+22, -54 to +100) but **39.1% over 32 games at the 45 s proxy (-77, -188 to +19)**, pooling to 48.4% over 96. Costs 12% of the node rate. The net already encodes mobility, so the term re-states what the leaf has and the cost is all that survives. Correct code, exact on 10,000 positions; kept on the branch. |
